...
// use NODE_ENV to not have to change config based on where it's deployed https://zizzamia.xyz
export const NEXT_PUBLIC_URL = process.env.NODE_ENV == "development" ? 'https://637d-2600-1700-9cc0-3ab0-4898-f7f9-6af3-aa8.ngrok-free.app/runners' : 'https://w3bbie.xyz/runners';
